diff --git a/code-review/01-core-infrastructure/.gitignore b/code-review/01-core-infrastructure/.gitignore
new file mode 100644
index 0000000..1900a45
--- /dev/null
+++ b/code-review/01-core-infrastructure/.gitignore
@@ -0,0 +1,4 @@
+node_modules/
+dist/
+coverage/
+.env
diff --git a/code-review/01-core-infrastructure/package-lock.json b/code-review/01-core-infrastructure/package-lock.json
new file mode 100644
index 0000000..59c38a1
--- /dev/null
+++ b/code-review/01-core-infrastructure/package-lock.json
@@ -0,0 +1,2140 @@
+{
...
+  }
+}
diff --git a/code-review/01-core-infrastructure/package.json b/code-review/01-core-infrastructure/package.json
new file mode 100644
index 0000000..5a9013f
--- /dev/null
+++ b/code-review/01-core-infrastructure/package.json
@@ -0,0 +1,38 @@
+{
+  "name": "code-review-agent",
+  "version": "0.1.0",
...
new file mode 100644
index 0000000..c000025
--- /dev/null
+++ b/code-review/01-core-infrastructure/src/index.ts
@@ -0,0 +1,2 @@
+#!/usr/bin/env node
+// CLI entry point — implemented in section-08
diff --git a/code-review/01-core-infrastructure/src/smoke.test.ts b/code-review/01-core-infrastructure/src/smoke.test.ts
new file mode 100644
index 0000000..d3a4b68
--- /dev/null
+++ b/code-review/01-core-infrastructure/src/smoke.test.ts
@@ -0,0 +1,7 @@
+import { describe, it, expect } from "vitest";
+
+describe("smoke test", () => {
+  it("confirms vitest is wired correctly", () => {
+    expect(true).toBe(true);
+  });
+});
diff --git a/code-review/01-core-infrastructure/tsconfig.json b/code-review/01-core-infrastructure/tsconfig.json
new file mode 100644
index 0000000..2e990c8
--- /dev/null
+++ b/code-review/01-core-infrastructure/tsconfig.json
@@ -0,0 +1,17 @@
+{
+  "compilerOptions": {
+    "target": "ES2022",
...
+}
diff --git a/code-review/01-core-infrastructure/vitest.config.ts b/code-review/01-core-infrastructure/vitest.config.ts
new file mode 100644
index 0000000..2e456d6
--- /dev/null
+++ b/code-review/01-core-infrastructure/vitest.config.ts
@@ -0,0 +1,9 @@
