...
Generate content for section `section-05-claude-client` (filename: `section-05-claude-client.md`).
...
for `section-05-claude-client` to understand what this section should contain.
...
`/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/sections/section-05-claude-client.md`
