...
Generate content for section `section-09-integration` (filename: `section-09-integration.md`).
...
for `section-09-integration` to understand what this section should contain.
...
`/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/sections/section-09-integration.md`
