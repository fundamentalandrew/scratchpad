...
Generate content for section `section-07-pipeline` (filename: `section-07-pipeline.md`).
...
for `section-07-pipeline` to understand what this section should contain.
...
`/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/sections/section-07-pipeline.md`
