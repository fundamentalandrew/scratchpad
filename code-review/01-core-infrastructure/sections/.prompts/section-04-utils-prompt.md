...
Generate content for section `section-04-utils` (filename: `section-04-utils.md`).
...
for `section-04-utils` to understand what this section should contain.
...
`/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/sections/section-04-utils.md`
