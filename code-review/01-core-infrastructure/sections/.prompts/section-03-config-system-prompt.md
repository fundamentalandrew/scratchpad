...
Generate content for section `section-03-config-system` (filename: `section-03-config-system.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/claude-plan.md` - Full implementation plan
2. `/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-config-system` to understand what this section should contain.
...
`/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/sections/section-03-config-system.md`
