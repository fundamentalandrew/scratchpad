...
Generate content for section `section-08-commands` (filename: `section-08-commands.md`).
...
for `section-08-commands` to understand what this section should contain.
...
`/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/sections/section-08-commands.md`
