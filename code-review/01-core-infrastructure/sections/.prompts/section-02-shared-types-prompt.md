...
Generate content for section `section-02-shared-types` (filename: `section-02-shared-types.md`).
...
for `section-02-shared-types` to understand what this section should contain.
...
`/Users/andrew/Code/scratchpad/code-review/01-core-infrastructure/sections/section-02-shared-types.md`
