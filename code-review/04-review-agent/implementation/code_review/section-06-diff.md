...
index 81d8eb2..e155fcd 100644
--- a/code-review/04-review-agent/tests/integration/review-agent.test.ts
...
+import type { AnalysisOutput, FileScore } from "../../src/types.js";
