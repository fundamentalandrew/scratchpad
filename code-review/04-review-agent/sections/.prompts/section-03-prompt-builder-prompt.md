...
Generate content for section `section-03-prompt-builder` (filename: `section-03-prompt-builder.md`).
...
for `section-03-prompt-builder` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/04-review-agent/sections/section-03-prompt-builder.md`
