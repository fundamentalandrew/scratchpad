...
Generate content for section `section-07-analysis-passthrough` (filename: `section-07-analysis-passthrough.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/andrew/code/scratchpad/code-review/04-review-agent/claude-plan.md` - Full implementation plan
2. `/home/andrew/code/scratchpad/code-review/04-review-agent/claude-plan-tdd.md` - Test stubs for each section
3. `/home/andrew/code/scratchpad/code-review/04-review-agent/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-07-analysis-passthrough` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/04-review-agent/sections/section-07-analysis-passthrough.md`
