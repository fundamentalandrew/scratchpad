...
Generate content for section `section-01-schema-updates` (filename: `section-01-schema-updates.md`).
...
for `section-01-schema-updates` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/04-review-agent/sections/section-01-schema-updates.md`
