...
Generate content for section `section-02-foundation` (filename: `section-02-foundation.md`).
...
for `section-02-foundation` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/04-review-agent/sections/section-02-foundation.md`
