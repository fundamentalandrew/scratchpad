...
Generate content for section `section-04-review-agent` (filename: `section-04-review-agent.md`).
...
for `section-04-review-agent` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/04-review-agent/sections/section-04-review-agent.md`
