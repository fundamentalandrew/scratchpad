diff --git a/code-review/03-analysis-agent/package-lock.json b/code-review/03-analysis-agent/package-lock.json
new file mode 100644
index 0000000..12f4cb9
--- /dev/null
+++ b/code-review/03-analysis-agent/package-lock.json
@@ -0,0 +1,1375 @@
+{
+  "name": "analysis-agent",
+  "version": "0.1.0",
...
+  }
+}
diff --git a/code-review/03-analysis-agent/package.json b/code-review/03-analysis-agent/package.json
new file mode 100644
index 0000000..fec8e34
--- /dev/null
+++ b/code-review/03-analysis-agent/package.json
@@ -0,0 +1,23 @@
+{
+  "name": "analysis-agent",
+  "version": "0.1.0",
...
@@ -0,0 +1 @@
+// Stub — implemented in section-04
diff --git a/code-review/03-analysis-agent/src/deterministic/types.ts b/code-review/03-analysis-agent/src/deterministic/types.ts
new file mode 100644
index 0000000..119462a
--- /dev/null
+++ b/code-review/03-analysis-agent/src/deterministic/types.ts
@@ -0,0 +1,27 @@
+import type { z } from "zod";
+import type { PRFileSchema } from "@core/agents/schemas.js";
+
...
+  afterContent?: string;
+}
diff --git a/code-review/03-analysis-agent/src/index.ts b/code-review/03-analysis-agent/src/index.ts
new file mode 100644
index 0000000..baca408
--- /dev/null
+++ b/code-review/03-analysis-agent/src/index.ts
@@ -0,0 +1,17 @@
+export type {
...
new file mode 100644
index 0000000..ab6a196
--- /dev/null
+++ b/code-review/03-analysis-agent/src/scoring/prompt-builder.ts
@@ -0,0 +1 @@
+// Stub — implemented in section-05
diff --git a/code-review/03-analysis-agent/src/scoring/types.ts b/code-review/03-analysis-agent/src/scoring/types.ts
new file mode 100644
index 0000000..e6c998e
--- /dev/null
+++ b/code-review/03-analysis-agent/src/scoring/types.ts
@@ -0,0 +1,35 @@
...
new file mode 100644
index 0000000..e695681
--- /dev/null
+++ b/code-review/03-analysis-agent/tests/unit/foundation.test.ts
@@ -0,0 +1,110 @@
+import { describe, it, expect } from "vitest";
+import { createAnalysisAgent } from "../../src/index.js";
+import type {
+  ClassificationResult,
+  FunctionInfo,
+  FilterResult,
+  AnalysisFile,
+} from "../../src/deterministic/types.js";
+import type {
+  ScoringContext,
+  ScoringFile,
+  FileBatch,
...
+  });
+});
diff --git a/code-review/03-analysis-agent/tsconfig.json b/code-review/03-analysis-agent/tsconfig.json
new file mode 100644
index 0000000..9e98aad
--- /dev/null
+++ b/code-review/03-analysis-agent/tsconfig.json
@@ -0,0 +1,20 @@
+{
+  "compilerOptions": {
+    "target": "ES2022",
...
+}
diff --git a/code-review/03-analysis-agent/vitest.config.ts b/code-review/03-analysis-agent/vitest.config.ts
new file mode 100644
index 0000000..ceacfec
--- /dev/null
+++ b/code-review/03-analysis-agent/vitest.config.ts
@@ -0,0 +1,15 @@
