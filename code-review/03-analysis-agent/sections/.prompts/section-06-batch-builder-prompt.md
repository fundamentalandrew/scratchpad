...
Generate content for section `section-06-batch-builder` (filename: `section-06-batch-builder.md`).
...
for `section-06-batch-builder` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/03-analysis-agent/sections/section-06-batch-builder.md`
