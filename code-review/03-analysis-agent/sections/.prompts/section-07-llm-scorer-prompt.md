...
Generate content for section `section-07-llm-scorer` (filename: `section-07-llm-scorer.md`).
...
for `section-07-llm-scorer` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/03-analysis-agent/sections/section-07-llm-scorer.md`
