...
Generate content for section `section-04-ast-classifier` (filename: `section-04-ast-classifier.md`).
...
for `section-04-ast-classifier` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/03-analysis-agent/sections/section-04-ast-classifier.md`
