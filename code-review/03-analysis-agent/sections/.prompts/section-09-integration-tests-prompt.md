...
Generate content for section `section-09-integration-tests` (filename: `section-09-integration-tests.md`).
...
for `section-09-integration-tests` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/03-analysis-agent/sections/section-09-integration-tests.md`
