...
Generate content for section `section-03-ast-analyzer` (filename: `section-03-ast-analyzer.md`).
...
for `section-03-ast-analyzer` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/03-analysis-agent/sections/section-03-ast-analyzer.md`
