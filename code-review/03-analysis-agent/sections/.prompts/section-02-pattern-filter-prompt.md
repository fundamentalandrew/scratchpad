...
Generate content for section `section-02-pattern-filter` (filename: `section-02-pattern-filter.md`).
...
for `section-02-pattern-filter` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/03-analysis-agent/sections/section-02-pattern-filter.md`
