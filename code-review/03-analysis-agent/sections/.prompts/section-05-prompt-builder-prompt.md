...
Generate content for section `section-05-prompt-builder` (filename: `section-05-prompt-builder.md`).
...
for `section-05-prompt-builder` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/03-analysis-agent/sections/section-05-prompt-builder.md`
