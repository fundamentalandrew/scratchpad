...
Generate content for section `section-07-output-agent` (filename: `section-07-output-agent.md`).
...
for `section-07-output-agent` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/05-interactive-output/sections/section-07-output-agent.md`
