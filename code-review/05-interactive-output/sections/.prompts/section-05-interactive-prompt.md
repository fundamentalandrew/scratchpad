...
Generate content for section `section-05-interactive` (filename: `section-05-interactive.md`).
...
for `section-05-interactive` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/05-interactive-output/sections/section-05-interactive.md`
