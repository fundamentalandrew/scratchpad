...
Generate content for section `section-01-setup` (filename: `section-01-setup.md`).
...
for `section-01-setup` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/05-interactive-output/sections/section-01-setup.md`
