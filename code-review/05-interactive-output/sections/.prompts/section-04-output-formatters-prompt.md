...
Generate content for section `section-04-output-formatters` (filename: `section-04-output-formatters.md`).
...
for `section-04-output-formatters` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/05-interactive-output/sections/section-04-output-formatters.md`
