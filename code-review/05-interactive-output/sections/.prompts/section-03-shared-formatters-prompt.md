...
Generate content for section `section-03-shared-formatters` (filename: `section-03-shared-formatters.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/andrew/code/scratchpad/code-review/05-interactive-output/claude-plan.md` - Full implementation plan
2. `/home/andrew/code/scratchpad/code-review/05-interactive-output/claude-plan-tdd.md` - Test stubs for each section
3. `/home/andrew/code/scratchpad/code-review/05-interactive-output/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-shared-formatters` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/05-interactive-output/sections/section-03-shared-formatters.md`
