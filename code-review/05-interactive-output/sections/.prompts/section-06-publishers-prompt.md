...
Generate content for section `section-06-publishers` (filename: `section-06-publishers.md`).
...
for `section-06-publishers` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/05-interactive-output/sections/section-06-publishers.md`
