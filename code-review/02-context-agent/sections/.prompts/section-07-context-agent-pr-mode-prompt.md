...
Generate content for section `section-07-context-agent-pr-mode` (filename: `section-07-context-agent-pr-mode.md`).
...
for `section-07-context-agent-pr-mode` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/02-context-agent/sections/section-07-context-agent-pr-mode.md`
