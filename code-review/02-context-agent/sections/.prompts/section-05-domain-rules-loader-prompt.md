...
Generate content for section `section-05-domain-rules-loader` (filename: `section-05-domain-rules-loader.md`).
...
for `section-05-domain-rules-loader` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/02-context-agent/sections/section-05-domain-rules-loader.md`
