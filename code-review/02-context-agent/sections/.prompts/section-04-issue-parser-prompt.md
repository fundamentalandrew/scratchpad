...
Generate content for section `section-04-issue-parser` (filename: `section-04-issue-parser.md`).
...
for `section-04-issue-parser` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/02-context-agent/sections/section-04-issue-parser.md`
