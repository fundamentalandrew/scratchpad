...
Generate content for section `section-01-schema-extensions` (filename: `section-01-schema-extensions.md`).
...
for `section-01-schema-extensions` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/02-context-agent/sections/section-01-schema-extensions.md`
