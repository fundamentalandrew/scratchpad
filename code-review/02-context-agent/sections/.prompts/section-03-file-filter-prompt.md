...
Generate content for section `section-03-file-filter` (filename: `section-03-file-filter.md`).
...
for `section-03-file-filter` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/02-context-agent/sections/section-03-file-filter.md`
