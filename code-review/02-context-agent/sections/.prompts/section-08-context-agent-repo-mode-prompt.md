...
Generate content for section `section-08-context-agent-repo-mode` (filename: `section-08-context-agent-repo-mode.md`).
...
for `section-08-context-agent-repo-mode` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/02-context-agent/sections/section-08-context-agent-repo-mode.md`
