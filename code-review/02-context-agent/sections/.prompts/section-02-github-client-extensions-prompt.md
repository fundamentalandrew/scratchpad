...
Generate content for section `section-02-github-client-extensions` (filename: `section-02-github-client-extensions.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/andrew/code/scratchpad/code-review/02-context-agent/claude-plan.md` - Full implementation plan
2. `/home/andrew/code/scratchpad/code-review/02-context-agent/claude-plan-tdd.md` - Test stubs for each section
3. `/home/andrew/code/scratchpad/code-review/02-context-agent/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-github-client-extensions` to understand what this section should contain.
...
`/home/andrew/code/scratchpad/code-review/02-context-agent/sections/section-02-github-client-extensions.md`
