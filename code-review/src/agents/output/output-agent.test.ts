...
import type { ContextOutput, ReviewOutput, Recommendation } from "../../agents/schemas.js";
import type { Logger } from "../../utils/logger.js";
import type { GitHubClient } from "../../clients/github.js";
import type { AnnotatedRecommendation, OutputConfig, OutputAgentDependencies } from "./types.js";

vi.mock("./interactive.js", () => ({
  runInteractiveReview: vi.fn(),
}));

vi.mock("./formatters/pr-comment.js", () => ({
  formatPRComment: vi.fn(),
}));

vi.mock("./formatters/markdown-file.js", () => ({
  formatMarkdownFile: vi.fn(),
}));

vi.mock("./publishers/github.js", () => ({
  publishPRComment: vi.fn(),
}));

vi.mock("./publishers/file.js", () => ({
...
import { createOutputAgent } from "./output-agent.js";
