CREATE TABLE `dc_benchmark_product` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `productUnique` (`date`,`product`,`siteId`,`clientType`),
  KEY `product` (`product`),
  KEY `clientType` (`clientType`),
  KEY `date` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=100963 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
